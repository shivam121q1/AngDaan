...
const RegisterBank = (props) => {
  ...
  const s1 =
    "mx-2 px-9 py-2 w-4/12 font-semibold rounded-full shadow-sm text-white-900 bg-blue-500 hover:drop-shadow-md hover:opacity-80 cursor-pointer";
  const submit = async (e) => {
    ...
    if (props.todo === "register") {
      await axios
        ...
        .then((r) => {
          alert("Registered New Organ Donation Camp ✅");
          navigate("/bank/camps");
        })
        .catch((e) => {
